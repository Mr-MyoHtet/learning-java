...
insert into section(course_id,end_at, fees, start_at,days,end_time,start_time) values ('1','2024-08-15', '150000', '2024-04-01', 'SATURDAY,SUNDAY','12:00','9:00');
insert into section(course_id,end_at, fees, start_at,days,end_time,start_time) values ('2','2024-08-15', '200000', '2024-04-01', 'MONDAY,TUESDAY,WEDNESDAY','16:00','13:00');
insert into section(course_id,end_at, fees, start_at,days,end_time,start_time) values ('3','2024-09-30', '400000', '2024-04-01', 'MONDAY,TUESDAY,WEDNESDAY','16:00','9:00');
insert into section(course_id,end_at, fees, start_at,days,end_time,start_time) values ('4','2024-08-15', '200000', '2024-04-01', 'MONDAY,TUESDAY,WEDNESDAY','12:00','9:00');
insert into section(course_id,end_at, fees, start_at,days,end_time,start_time) values ('5','2024-08-15', '200000', '2024-04-01', 'SATURDAY,SUNDAY','16:00','13:00');
insert into section(course_id,end_at, fees, start_at,days,end_time,start_time) values ('1','2024-12-10', '150000', '2024-10-01', 'SATURDAY,SUNDAY','16:00','9:00');
...
insert into section(course_id,end_at, fees, start_at,days,end_time,start_time) values ('3','2024-12-10', '200000', '2024-10-01', 'MONDAY,TUESDAY,WEDNESDAY','16:00','9:00');
insert into section(course_id,end_at, fees, start_at,days,end_time,start_time) values ('4','2024-12-10', '200000', '2024-10-01', 'MONDAY,TUESDAY,WEDNESDAY','16:00','9:00');

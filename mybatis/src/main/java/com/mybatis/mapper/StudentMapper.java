...
public interface StudentMapper {
	...
	// Using @selectProvider
	@SelectProvider(type = StudentSqlProvider.class, method = "buildSelect")
	List<Student> selectStudent(@Param("name") String name, @Param("email") String email, @Param("bio") String bio);

	//Using InsertProvider

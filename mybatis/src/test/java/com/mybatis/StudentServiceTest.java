...
public class StudentServiceTest {
	...
	// t.getAddress().getCity().equals("CHICAGO")).map(Tutors::getName)
	...
	void findAllStudents() {
		final Logger logger = LogManager.getLogger(StudentServiceTest.class);
	...
	@Test
	void selectStudent() {
		List<Student> result = studentService.selectStudent(null, "aunghh@gmail.com", "Developer");

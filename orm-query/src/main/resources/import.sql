...
insert into section(course_id,end_at, fees, start_at,days,end_time,start_time) values ('6','2024-12-10', '150000', '2024-10-05', 'SATURDAY,SUNDAY','16:00','9:00');
insert into section(course_id,end_at, fees, start_at,days,end_time,start_time) values ('7','2024-12-10', '200000', '2024-10-01', 'MONDAY,TUESDAY,WEDNESDAY','12:00','13:00');
insert into section(course_id,end_at, fees, start_at,days,end_time,start_time) values ('8','2024-12-10', '200000', '2024-10-02', 'MONDAY,TUESDAY,WEDNESDAY','16:00','9:00');
insert into section(course_id,end_at, fees, start_at,days,end_time,start_time) values ('9','2024-12-10', '200000', '2024-10-03', 'MONDAY,TUESDAY,WEDNESDAY','16:00','9:00');
